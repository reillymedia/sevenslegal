...
yoast_title: The Steps of a Criminal Trial
yoast_description: >-
  During a criminal trial a jury examines the evidence presented by the defense
  and prosecution to decide whether a defendant committed a crime.
categories:
  - Blog
  - Criminal Law
pfd_file: ''
...
tags:
  ...
  - jury instruction
  - witness testimony
url: /blog/steps-criminal-trial/535/
...
The first step then of a&nbsp;[criminal trial](https://sevenslegalstg.wpengine.com/)&nbsp;is to select the jury. During jury selection, the judge, the prosecutor (representing the government), and the defendant (through his or her respective&nbsp;[criminal defense attorney](https://sevenslegalstg.wpengine.com/)) will screen potential jurors from a pool of jurors.
